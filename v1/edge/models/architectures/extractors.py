# -*- coding: utf-8 -*-
"""
Created on Fri Oct  5 16:53:35 2018
...
#        if k1 == 'conv1.weight':
#            v1 = v1[:,0,:,:]
#            new_dict[k1] = v1[:,np.newaxis,:,:]
#        else:
#            new_dict[k1] = v1
#        #print k1, new_dict[k1].shape
#        print k1, v1.shape
#            
#    target.load_state_dict(new_dict)
